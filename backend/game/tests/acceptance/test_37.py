...
#         driver.find_element_by_id("id_official_repository").clear()
#         driver.find_element_by_id("id_official_repository").send_keys("https://github.com/LManaslu/Wenova")
...
#         driver.find_element_by_link_text("Wenova").click()
#         driver.find_element_by_id("id_name").clear()
#         driver.find_element_by_id("id_name").send_keys("Wenova: Rise of Conquerors")
#         driver.find_element_by_name("_save").click()
